...
import 'package:flutter_application_prgrado/data/data_sources/local/app_database.dart';
  ...
  Future<DataState<List<ArticleModel>>> getNewsArticles() async {
    /*try {
      final httpResponse = await _newsApiService.getNewsArticles(
        apiKey: prototypeApi,
        country: prototypeApi,
        category: prototypeApi,
      );
    ...
    var httpResponse;
    return DataFailed(DioException(
        error: httpResponse.responseStatus.statusMessage,
        response: httpResponse.responseStatus,
        type: DioExceptionType.badResponse,
        requestOptions: httpResponse.responseStatus.requestOptions));
  }
